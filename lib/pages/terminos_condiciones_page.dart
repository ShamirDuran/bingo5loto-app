  ...
  Widget _body(BuildContext context) {
    return Container(
      ...
      child: ListView(
        ...
        children: [
          Text("TERMINOS Y CONDICIONES", style: Theme.of(context).textTheme.headline6),
          ...
          textItem("2.	Los cartones y la balotera contienen números generados aleatoriamente del 1 al 75."),
          textItem(
          ...
          textItem("6.	El Premio-1 se obtendrá cuando se complete un Patrón con máximo 43 balotas jugadas."),
          textItem("7.	El Premio-2 se obtendrá cuando se complete un cartón con máximo 58 balotas jugadas."),
          textItem(
